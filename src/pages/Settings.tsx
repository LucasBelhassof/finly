...
import { useExportAccountJson, useExportTransactionsCsv } from "@/hooks/use-user-data";
...
export default function SettingsPage() {
  ...
  const exportJson = useExportAccountJson();
  ...
  return (
    <>
      <AppShell
        title="Configurações"
        description="Conta, segurança, perfil, preferências e informações técnicas do app"
      >
        <div className="grid grid-cols-1 gap-6 xl:grid-cols-[minmax(0,1.25fr)_380px]">
          <div className="space-y-6">
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormDescription>
                              Use o e-mail que você quer manter como principal na conta.
                            </FormDescription>
                            <FormMessage />
                          </FormItem>
                        )}
            ...
            <div data-tour-id="settings-data-controls">
              <SettingsSection
                icon={<Database size={20} />}
                title="Dados e Privacidade"
                description="Exporte seus dados ou encerre permanentemente sua conta."
              >
                <div className="space-y-4">
                  <div>
                    <p className="mb-3 text-sm font-medium text-foreground">Exportar dados</p>
                    <div className="flex flex-wrap gap-3">
                      ...
                      >
                        {exportCsv.isPending ? <Loader2 size={16} className="animate-spin" /> : <Download size={16} />}
                      ...
                      >
                        {exportJson.isPending ? <Loader2 size={16} className="animate-spin" /> : <Download size={16} />}
                  ...
                  <div className="rounded-xl border border-destructive/40 bg-destructive/5 p-4">
                    <p className="mb-1 text-sm font-medium text-destructive">Zona de perigo</p>
